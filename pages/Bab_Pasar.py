...
st.header(":blue[BAB PERDAGANGAN - PASAR]")
...
pilihanjenjang = ['tokokelontong', 'pasar_permanen', 'pasar_semipermanen', 'pasar_tanpa_bangunan']
...
with kol1c:
    dataterpilih = st.selectbox("Filter Jenis Pasar", pilihanjenjang, key='tahun2')
with kol1d:
