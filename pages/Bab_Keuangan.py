...
st.header(":blue[BAB KEUANGAN - PENDAPATAN DESA]")
...
datakk = pd.read_excel("data/pendapatan_desa.xlsx")
...
with st.container(border=True):
    st.info(f"{dataterpilih} di Kecamatan {pilihkec}, {pilihkab} Tahun {pilihtahun} (Rupiah)")
...
st.link_button("sumber Data", url="https://portaldatadesa.jabarprov.go.id/index-profile-desa/Ekonomi/Pendapatan-Desa")